import { CasMismatchError, CouchbaseError, DocumentExistsError, DocumentNotFoundError, RequestCanceledError, ServiceNotAvailableError, TimeoutError, ValueTooLargeError, } from "couchbase";
function isCouchbaseError(error) {
    return error instanceof CouchbaseError;
}
export function handleCouchbaseError(error, id) {
